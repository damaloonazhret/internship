...
export const BG_INFO = 'And here you can choose the background color on the site'
export const TXT_INFO = 'Here you can set your text content color for the page'
